                        ...
                        <tr>
                            ...
                            <td>
                                {info.films.map(item =>(
                                    <span>
                                        <a href={item}>
                                            {item.split("https://swapi.co/api/films/")}
                                        </a>
                                    </span>
                            ...
                            <td>
                            {info.vehicles.map(item =>(
                                    <span>
                                        <a href={item}>
                                            {item.split("https://swapi.co/api/vehicles/")}
                                        </a>
                                    </span>
                                    // <span className="teste"></span> 
                                ))}
                            ...
                            <td>
                                {info.starships.map(item =>(
                                    <span>
                                        <a href={item}>
                                            {item.split("https://swapi.co/api/starships/")}
                                        </a>
                                    </span>
                                    // <span className="teste"></span> 
                                ))}
                            </td>
                            <td>{info.species.map(item =>(
                                    <span>
                                        <a href={item}>
                                            {item.split("https://swapi.co/api/species/")}
                                        </a>
                                    </span>
                                    // <span className="teste"></span> 
                                ))}</td>
